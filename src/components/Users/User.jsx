...
export const User = ({id,isInvite,checkInvitation,email,avatar,first_name,last_name}) => (
  <li>
    <div>
    ...
    <img 
    onClick={()=>checkInvitation(id)}
    className="action" src={`/assets/${isInvite?'minus':'plus'}.svg`} alt="Action" />
  </li>
);
